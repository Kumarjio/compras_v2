...
<p class="help-block"><strong>Recuerde!</strong> 
    ...
    <?php echo $form->hiddenField($model,'producto_detalle_om'); ?>
    <?php if($model->nit != ""): ?>
    ...
    <div class="row">
        <div class="col-md-4">
            <?php echo $form->textFieldGroup($model,'cantidad',array( 'widgetOptions'=>array('htmlOptions'=>array('class'=>'col-md-6', "style"=>"text-align:right;")))); //, 'placeholder'=>'0,00'?>
        </div>
        <div class="col-md-4">
            <?php echo $form->textFieldGroup($model,'valor_unitario',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'col-md-6', "style"=>"text-align:right;")))); //, 'placeholder'=>'0,00' ?>
        </div>
        <div class="col-md-4">
            <?php echo $form->dropDownListGroup(
                $model,
...
<br />
    ...
    <div class="row">
        ...
        <div id="trm" class="<?php echo $class ?>" style="<?php echo $style ?>" >
            <?php echo $form->textFieldGroup($model,'trm',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'col-md-6', 'readonly' => 'readonly', "style"=>"text-align:right;", 'placeholder'=>'0,00')))); ?>
        </div>
...
<script type="text/javascript">
    //$("#OmCotizacion_cantidad").mask("###.###.###.##0,00",{reverse: true});
    //$("#OmCotizacion_valor_unitario").mask("###.###.###.##0,00",{reverse: true});
    //$("#OmCotizacion_trm").mask("###.###.###.##0,00",{reverse: true});
</script>