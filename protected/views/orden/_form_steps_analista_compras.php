                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <h2 class="StepTitle">Productos</h2><br />
                      <?php echo $this->renderPartial('_modificar_productos_analista', array('paso_actual'=>$paso_actual, 'orden'=>$model, 'model'=>$orden_solicitud))   ?>
