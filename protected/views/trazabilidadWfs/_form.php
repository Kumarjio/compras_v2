<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'usuario_anterior',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'usuario_nuevo',array('class'=>'span5')); ?>
