...
<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array( 
	...
	'htmlOptions' => array(
		'onsubmit'=> 'jQuery.ajax({\'url\':\''.Yii::app()->createUrl('actividadesJairo/devolver').'\',\'dataType\':\'json\',\'data\':$(this).serialize(),\'type\':\'post\',\'success\':function(data){if(data.status == \'success\'){$(\'#modal-gestion\').modal(\'hide\'); parent.window.location.reload();}else{	$(\'#body-gestion\').html(data.content);}},\'cache\':false});return false;'
	)
));?>
<?php /*$form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array( 
	'id'=>'form-gestion-default',
...
<div class='col-md-12'>
  <strong>Devolver a :</strong>
    <div class="form-group">
      <?php echo CHtml::dropDownList('actividad','',$actividades,array('class'=>'form-control')); ?>
    </div>
</div>
