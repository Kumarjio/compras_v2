...
<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array( 
	...
	'htmlOptions' => array(
		'onsubmit'=> 'jQuery.ajax({\'url\':\'/correspondencia/index.php/roles/create\',\'dataType\':\'json\',\'data\':$(this).serialize(),\'type\':\'post\',\'success\':function(data){if(data.status == \'success\'){$(\'#dialogo-rol\').modal(\'hide\'); $(\'#rol-grid\').yiiGridView.update(\'rol-grid\');}else{$(\'#body-rol\').html(data.content);}},\'cache\':false});return false;'
	),
	'clientOptions' => array(
