...
foreach ($model as $consulta) {
	$objPHPExcel->getActiveSheet()->SetCellValue("A".$fila, strtoupper($consulta->nombre_destinatario)); 
	$objPHPExcel->getActiveSheet()->SetCellValue("B".$fila, strtoupper($consulta->direccion));
	$objPHPExcel->getActiveSheet()->SetCellValue("C".$fila, strtoupper($consulta->na0->ciudad0->nombre_ciudad));
	...
	$objPHPExcel->getActiveSheet()->SetCellValue("J".$fila, $consulta->na); 
 	$objPHPExcel->getActiveSheet()->SetCellValue("K".$fila, strtoupper($consulta->na0->tipologia0->tipologia)." - ".strtoupper($consulta->na0->tipologia0->area0->area));
