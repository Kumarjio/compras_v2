...
<div class="panel panel-blue margin-bottom-40">
	<div class="panel-body"> 
		<?php $this->widget('bootstrap.widgets.BootGridView',array(
			...
			'dataProvider'=>$model->searchFisicas(),
			'ajaxType'=>'POST',
			...
			array('header'=>'Área',
				  'value'=>'$data->na0->tipologia0->area0->area',
				  'filter'=> CHtml::textField('area','',array('class'=>'form-control')),),
			array('header'=>'Fecha',
				  'value'=>'date("d/m/Y", strtotime($data->na0->fecha_entrega))',
				  'filter'=> CHtml::textField('fecha','',array('class'=>'form-control')),),
			array('header'=>'Hora',
				  'value'=>'date("h:i a", strtotime($data->na0->hora_entrega))',
	        ...
	        'success' => 'function(res){
	        	if(res != ""){
	        		if(confirm("¿Desea descargar informe punteados?")){
						$("#excel1").attr("src", \''.$this->createUrl("cartas/punteoExcel").'\').load();
						$("#excel2").attr("src", \''.$this->createUrl("cartas/punteoExcel472").'\').load();
	        		}
	        	}else{
