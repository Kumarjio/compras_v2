...
foreach ($model as $consulta) {
	...
	$objPHPExcel->getActiveSheet()->SetCellValue("G".$fila, strtoupper($consulta->nombre_destinatario));
	$objPHPExcel->getActiveSheet()->SetCellValue("H".$fila, strtoupper($consulta->direccion));
	$objPHPExcel->getActiveSheet()->SetCellValue("I".$fila, strtoupper($consulta->na0->ciudad0->nombre_ciudad));
	$objPHPExcel->getActiveSheet()->SetCellValue("J".$fila, strtoupper($consulta->na0->ciudad0->idDepartamento->nombre_departamento));
	$objPHPExcel->getActiveSheet()->SetCellValue("K".$fila);
	$objPHPExcel->getActiveSheet()->SetCellValue("N".$fila, $unidad);
	$objPHPExcel->getActiveSheet()->SetCellValue("O".$fila, strtoupper($consulta->na0->tipologia0->area0->area)); 
	...
	$objPHPExcel->getActiveSheet()->SetCellValue("AD".$fila, $consulta->na);
	$objPHPExcel->getActiveSheet()->SetCellValue("AE".$fila, strtoupper($consulta->na0->tipologia0->tipologia));
	...
	Cartas::actualizaPunteo($consulta->id);
	$fila++;
}
