...
<div class='col-md-6'>
	...
	<div class="form-group">
   		<?php echo $form->textField($model,'nombres',array('class'=>'form-control inicial','maxlength'=>'50','onKeypress'=>'return soloLetras(event)','readonly'=>'true')); ?>
  	</div>
</div>
<div class='col-md-6'>
	<?php echo $form->labelEx($model,'apellidos'); ?>
	<div class="form-group">
   		<?php echo $form->textField($model,'apellidos',array('class'=>'form-control inicial','maxlength'=>'50','onKeypress'=>'return soloLetras(event)','readonly'=>'true')); ?>
  	</div>
</div>
<div class='col-md-4'>
	<?php echo $form->labelEx($model,'usuario'); ?>
	<div class="form-group">
   		<?php echo $form->textField($model,'usuario',array('class'=>'form-control','maxlength'=>'10','onKeypress'=>'if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;','readonly'=>'true')); ?>
  	</div>
</div>
<div class='col-md-4'>
	<?php echo $form->labelEx($model,'contraseña'); ?>
	<div class="form-group">
   		<?php echo $form->passwordField($model,'contraseña',array('class'=>'form-control','readonly'=>'true')); ?>
  	</div>
</div>
<div class='col-md-4'>
	<?php echo $form->labelEx($model,'repetir'); ?>
	<div class="form-group">
   		<?php echo $form->passwordField($model,'repetir',array('class'=>'form-control','readonly'=>'true')); ?>
  	</div>
</div>
<div class='col-md-12'>
