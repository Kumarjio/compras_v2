...
function setEmpleado(event){
	...
	var input_name = "input[name='TipoCompra[responsable]']";
	$(input_name).val(id_empleado);
	var input_nombre = "input[name='TipoCompra[responsable]_2']"; 
...
<?php $this->widget('bootstrap.widgets.BootGridView',array(
    ...
    'dataProvider'=>$empleado_model->search_3(),
...
<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array(
	...
	<label for="TipoCompra_responsable">Responsable <span class="required">*</span></label><input class="span5" name="TipoCompra[responsable]_2" id="TipoCompra_responsable_nombre" type="text" disabled="disabled" value="<?php 
	$query = Empleados::model()->findAllByPk($model->responsable);
	if(count($query) >0){
		$empleado = $query[0];
		echo $empleado->nombre_completo;
	} ?>">
	
	<?php echo $form->hiddenField($model,'responsable',array('class'=>'span5')); ?>
	<?php $this->widget('bootstrap.widgets.BootButton', array(
