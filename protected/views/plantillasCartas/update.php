...
<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array( 
	'id'=>'form-update-plantilla',
	'enableAjaxValidation'=>false,
	'enableClientValidation' => true,
	'htmlOptions' => array(
		'onsubmit'=> 'jQuery.ajax({\'url\':\''.Yii::app()->createUrl('plantillasCartas/update').'\',\'dataType\':\'json\',\'data\':$(this).serialize(),\'type\':\'post\',\'success\':function(data){if(data.status == \'success\'){$(\'#dialogo-plantilla\').modal(\'hide\'); $(\'#plantilla-grid\').yiiGridView.update(\'plantilla-grid\');}else{$(\'#body-plantilla\').html(data.content);}},\'cache\':false});return false;'
	),
	'clientOptions' => array(
...
<div class='col-md-12 oculto'>
      <div class="form-group">
        <?php echo CHtml::textArea('carta_update','',array('class'=>'form-control')); ?>
      </div>
</div>
<div class='col-md-12'>
...
<div class='col-md-1'>
	...
	<?php $this->widget('bootstrap.widgets.BootButton', array( 
		...
		'type'=>'info', 
		'label'=>'Guardar',
		'htmlOptions' => array('id'=>'update_carta'), 
	)); ?>
	</div>
</div>
<?php $this->endWidget(); ?>
