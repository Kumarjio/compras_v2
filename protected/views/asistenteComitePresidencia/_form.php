...
function setEmpleado(event){
	...
	var input_name = "input[name='AsistenteComitePresidencia[id_empleado]']";
	$(input_name).val(id_empleado);
	var input_nombre = "input[name='AsistenteComitePresidencia[id_empleado]_2']"; 
...
<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array(
	'id'=>'asistente-comite-presidencia-form',
	...
	<label for="AsistenteComitePresidencia_id_empleado">Empleado</label><input class="span5" name="AsistenteComitePresidencia[id_empleado]_2" id="AsistenteComitePresidencia_id_empleado_nombre" type="text" disabled="disabled" value="<?php 
