...
class Ciudades extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('codigo, ciudad', 'required'),
			array('departamento, codigo_departamento', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('codigo, ciudad, departamento, codigo_departamento', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'recepcions' => array(self::HAS_MANY, 'Recepcion', 'ciudad'),
		);
	}
	...
	public static function cargaCiudades()
	{
	 	$documentos = CHtml::listData(Ciudades::model()->findAll(array('order' => 'ciudad')),'codigo','ciudad');
	 	return $documentos;
	}
}
