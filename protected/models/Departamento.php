...
class Departamento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_departamento, nombre_departamento', 'required'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_departamento, nombre_departamento', 'safe', 'on'=>'search'),
		);
	}
	...
	{
	 	return CHtml::listData(Departamento::model()->findAll(array('order' => 'nombre_departamento')),'id_departamento','nombre_departamento');
