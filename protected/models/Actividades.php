...
class Actividades extends CActiveRecord
{
	...
	public static function nombreActividad($id_actividad)
	{
		$actividad = ActividadTipologia::model()->findByAttributes(array("id"=>$id_actividad));
		return ucwords(strtolower($actividad->idActividad->actividad));
	}
