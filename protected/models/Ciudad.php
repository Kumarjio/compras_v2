...
class Ciudad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_ciudad, id_departamento, codigo_ciudad, nombre_ciudad', 'required'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_ciudad, id_departamento, codigo_ciudad, nombre_ciudad', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'cartases' => array(self::HAS_MANY, 'Cartas', 'id_ciudad'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('codigo_ciudad',$this->codigo_ciudad,true);
