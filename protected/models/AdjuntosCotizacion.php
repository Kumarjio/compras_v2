 ...
 */
class AdjuntosCotizacion extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('cotizacion, path, tipi, nombre, usuario', 'required'),
			array('cotizacion', 'numerical', 'integerOnly'=>true),
			array('tipi, path', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, cotizacion, path, tipi, nombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cotizacion0' => array(self::BELONGS_TO, 'Cotizacion', 'cotizacion'),
		);
	}
	...
	public function search($cot)
	{
		...
		$criteria->condition = "cotizacion = :c";
