<?php
/**
 * This is the model class for table "cargue_comun".
 *
 * The followings are the available columns in table 'cargue_comun':
 * @property string $id
 ...
 */
class CargueComun extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('siniestro, nombre, direccion, ciudad, diagnostico, nombre_empresa, direccion_empresa, ciudad_empresa, eps, direccion_eps, ciudad_eps, afp, direccion_afp, telefono_afp, ciudad_afp, usuario_cargue', 'required'),
			array('telefono, departamento, telefono_empresa, telefono_eps, na', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, siniestro, nombre, direccion, telefono, ciudad, departamento, diagnostico, nombre_empresa, direccion_empresa, telefono_empresa, ciudad_empresa, eps, direccion_eps, telefono_eps, ciudad_eps, afp, direccion_afp, telefono_afp, ciudad_afp, usuario_cargue, fecha_cargue, na', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CargueComun the static model class
	 */
