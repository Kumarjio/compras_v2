...
class Proveedores extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, proveedor', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cartases' => array(self::HAS_MANY, 'Cartas', 'proveedor'),
		);
	}
	...
	public static function cargaProveedores($className=__CLASS__)
	{
		$proveedor = CHtml::listData(Proveedores::model()->findAll(array('order' => 'id')),'id','proveedor');
	 	return $proveedor;
	}
}
