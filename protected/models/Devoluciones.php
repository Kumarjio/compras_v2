 ...
 * @property Trazabilidad $desde0
 * @property Trazabilidad $hasta0
 */
class Devoluciones extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('desde, hasta', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			'desde0' => array(self::BELONGS_TO, 'Trazabilidad', 'desde'),
			'hasta0' => array(self::BELONGS_TO, 'Trazabilidad', 'hasta'),
		);
	}
