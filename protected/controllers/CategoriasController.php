...
array('allow', // allow authenticated user to perform 'create' and 'update' actions
	'actions'=>array('create','update','admin','index','view', 'traerFamilias'),
	'users'=>array('@'),
),
...
public function actionAdmin()
{
	...
	public function actionTraerFamilias(){
		$categoria = $_POST['Producto']['id_categoria'];
		if(!empty($categoria)){

			$familias = CHtml::listData(FamiliaProducto::model()->findAllByAttributes(array('id_categoria'=>$categoria)),'id','nombre');

		 	echo CHtml::tag('option',array('value'=>''),'Seleccione...',true);
			if($familias){
				foreach ($familias as $valor => $nombre) {
