...
class ControlFlujoController extends Controller{
	...
	public function accessRules(){
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('establecerTipologia', 'createTipologia','agregarTipologia','updateTipologia','guardarConexiones', 'deleteFlujo','inhabilitarTipologia', 'definirFlujo','usuariosFlujo','validaActividad'),
				'users'=>array('@'),
			),
	...
	*/
	...
	private function devolverFlujo($tipo){
		...
		$tipologia = $tipo;
		ActividadTipologia::guardaEstado($estado = false, $tipologia);
	...
	public function actionGuardarConexiones(){
		...
		try {
			...
			ActividadTipologia::guardaEstado($estado = true, $tipologia);
	...
	/*public function actionUsuariosFlujo(){
		$i = 0;
		$usuario = array();
		$nombre = "";
		$usuarios = UsuariosActividadTipologia::model()->findAllByAttributes(array('id_actividad_tipologia'=>$ac->id));
