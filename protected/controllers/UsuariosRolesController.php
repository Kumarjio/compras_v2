...
class UsuariosRolesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','usuariosRoles'),
				'users'=>array('@'),
			),
	 ...
	 * @return UsuariosRoles the loaded model
	 ...
	 * @param UsuariosRoles $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='usuarios-roles-form')
		{
	...
	public function actionUsuariosRoles()
	{
		if(Yii::App()->request->isAjaxRequest){
			$model = new UsuariosRoles('search_detalle');
			echo CJSON::encode(array('status'=>'success', 'content' => $this->renderPartial('roles', array('model' => $model), true, true)));
		}
	}
}
