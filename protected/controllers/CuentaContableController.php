...
class CuentaContableController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['CuentaContable'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['CuentaContable']))
			$model->attributes=$_GET['CuentaContable'];
	...
	{
		$model=CuentaContable::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cuenta-contable-form')
		{
