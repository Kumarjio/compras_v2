...
class CentroCostosController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','admin','fromorden', 'delete'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CentroCostos']))
		{
			$model->attributes=$_POST['CentroCostos'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['CentroCostos']))
			$model->attributes=$_GET['CentroCostos'];
	...
	public function actionFromOrden()
	{
	...
	{
		$model=CentroCostos::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='centro-costos-form')
		{
