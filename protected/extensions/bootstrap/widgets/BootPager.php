...
class BootPager extends CLinkPager
{
	...
	public function init()
	{
		if ($this->nextPageLabel === null)
			$this->nextPageLabel = Yii::t('bootstrap','Siguiente').' &rarr;';

		if ($this->prevPageLabel === null)
			$this->prevPageLabel = '&larr; '.Yii::t('bootstrap','Anterior');

		if ($this->firstPageLabel === null)
			$this->firstPageLabel = Yii::t('bootstrap','Primero');

		if ($this->lastPageLabel === null)
			$this->lastPageLabel = Yii::t('bootstrap','Último');
